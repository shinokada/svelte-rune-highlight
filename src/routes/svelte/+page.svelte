<script lang="ts">
  ...
  const modules = import.meta.glob('./samples/**/*.{svelte,md}', { query: '?raw', import: 'default', eager: true });
...
<p>Use the HighlightSvelte component to highlight your Svelte code. The HighlightSvelte component requires code props. <code>langtag</code> and <code>--langtag-color</code> are optional.</p>

<h2>Example 1</h2>
<HighlightCompo code={modules['./samples/highlight/example-1.md'] as string} />
